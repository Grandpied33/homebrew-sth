...
This repository distributes the Homebrew formula for STH.

## Report a vulnerability privately

Use [GitHub private vulnerability reporting](https://github.com/Skills-transfer-hub/homebrew-sth/security/advisories/new). Do not disclose vulnerabilities, tokens, private keys or exploit details in public issues or pull requests.
